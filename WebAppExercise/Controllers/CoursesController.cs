...
namespace WebAppExercise.Controllers
{
    ...
    {
        private readonly WebAppExerciseContext _context;

        public CoursesController(WebAppExerciseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Course != null ? 
                          ...
                          Problem("Entity set 'WebAppExerciseContext.Course'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppExerciseContext.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
